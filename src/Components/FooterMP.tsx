...
import "../styles/FooterMainPage.css"
        ...
        <div className="FooterMPMainContainer">
            <div className="FooterMPContainer">
                <div className="FirstFooterMP">
                    ...
                    <div style={{width:"310px",lineHeight:"20px",color:"#6B7280",fontWeight:"400",fontSize:"14px",marginTop:"20px",marginBottom:"30px",fontFamily:"Roboto"}}>
                ...
                <div className="SecondFooterMP">
                    <div>
                        <div className="TextBoldFooter">
                            Характеристики
                        </div>
                        <div className="defaultTextFooter">
